...
a persistence unit "LoginPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Login\pom.xml":
...
artifact ("Login.war") is already built. You can build
